...
@interface SFCDriverSynchroViewController ()<TNKCarNaviViewDelegate, TNKCarNaviDelegate, TLSDriverManagerDelegate, TencentLBSLocationManagerDelegate, QMapViewDelegate>
